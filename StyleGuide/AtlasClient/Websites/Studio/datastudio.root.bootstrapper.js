...
if (inAdalIframe) {
    ...
    requirejs(["jquery", "knockout", "knockout-mapping"], function () {
        ...
        require(["datastudio.controls", "datastudio.graphControl/Bindings/graphControlBinding", "datastudio"], function () {
            var defaultModuleName = "designguide";
            var modulesConfig = [{"name":"datastudio-datacatalog","location":"node_modules/@ms-atlas-module/datastudio-datacatalog","main":"startup.js","resxPath":"i18n!node_modules/@ms-atlas-module/datastudio-datacatalog/nls/resx"},{"name":"datastudio-designguide","location":"node_modules/@ms-atlas-module/datastudio-designguide","main":"startup.js"}];
            var shellVersion = "ShellV2";
            var useExternalAPI = false;
