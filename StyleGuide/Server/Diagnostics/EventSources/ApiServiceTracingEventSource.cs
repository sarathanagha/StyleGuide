...
{
    [EventSource(Name = "Microsoft-Atlas-ApiServiceTraces", Guid = "5218C6F4-7F37-428F-A3C4-287389340ECA")]
    public class ApiServiceTracingEventSource : ServiceTracingEventSource
    {
        public ApiServiceTracingEventSource()
        {
        }

        public static ApiServiceTracingEventSource Log
        {
            get
            {
                return EventSources.ApiServiceTracingEventSource;
            }
        }
