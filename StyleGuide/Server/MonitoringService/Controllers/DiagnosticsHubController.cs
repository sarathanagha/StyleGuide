...
using Microsoft.DataStudio.UxMonitoring.WebRole.Contracts;
using Microsoft.DataStudio.WebRole.Common.Controllers;
using Newtonsoft.Json;
using ILogger = Microsoft.DataStudio.Diagnostics.ClientUX.ILogger;

namespace Microsoft.DataStudio.UxMonitoring.WebRole.Controllers
{
    [Authorize]
    public class DiagnosticsHubController : ControllerBase
    {
