...
module.exports = /*@ngInject*/ function($timeout, $state, $modal, $scope,
	uiGmapIsReady, MapService,findMyCarService,$rootScope,StatusBarService, $window) {
	...
	vm.ShowcarLocation=function(){
		...
		findMyCarService.getcarLocation().then(function(resp){
			//StatusBarService.showLoadingStatus();
			var item = resp.serviceResponse;
			//console.log("service Response::::",resp);
			$rootScope.inProg=false;
...
$scope.location=resp.serviceResponse.coord;
